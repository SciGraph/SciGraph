...
public class EntityProcessorImplIncorrectIndexesTest {
  ...
  public void setUp() throws Exception {
    config = new EntityFormatConfiguration.Builder(new StringReader(text))
      .writeTo(new Writer() {
