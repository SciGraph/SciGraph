...
public class EquivalentToInverseTest extends GraphTestBase {
  ...
  @Test
  public void noEquivalentPropertyEdge() {
    try (Transaction tx = graphDb.beginTx()) {
      for (Node n : graphDb.getAllNodes()) {
        assertFalse(n.hasRelationship(RelationshipType.withName("equivalentProperty")));
      }
      tx.success();
    }
  }
